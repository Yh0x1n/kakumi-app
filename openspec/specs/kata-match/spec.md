...
Define the behavior of kata match operations, including how referee judge panels are loaded and assigned for kata matches. Kata (forms) judging does not assign specific roles to referees — all referees in the system are eligible to serve on a kata panel.
