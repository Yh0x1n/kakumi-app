...
class TournamentCategoryState(CrudStateMixin, rx.State):
    ...
    modality_options: list[str] = [modality.value for modality in Modality]
    gender_options: list[str] = ["MALE", "FEMALE", "MIXED"]
    competition_system_options: list[str] = [
        system.value for system in CompetitionSystem
    ]
    ...
    def reset_form(self) -> None:
        ...
        self.name = ""
        self.modality = Modality.KATA_INDIVIDUAL.value
        self.gender = "MALE"
        self.min_age = "0"
        self.max_age = "99"
        self.min_belt_rank = ""
        self.max_belt_rank = ""
        self.competition_system = CompetitionSystem.ELIMINATION.value
        self.bracket_size = "8"
    ...
    def set_form_values(
        ...
        if category:
            ...
            self.modality = category.get("modality", Modality.KATA_INDIVIDUAL.value)
            self.gender = category.get("gender", "MALE")
            ...
            self.competition_system = category.get(
                "competition_system",
    ...
    def _validate_form(self) -> Optional[dict[str, Any]]:
        ...
        return {
            ...
            "competition_system": self.competition_system,
